            ...
            <div className="w-full lg:w-1/2 min-h-full flex items-center">
              <div>
                ...
                <p className="text-center lg:text-start text-[20px] font-normal mt-[36px] lg:mr-12 leading-[140%]">
                  Kebun Bibit Wonorejo adalah ruang hijau yang menawarkan
                  keindahan alam, beragam tanaman, dan pengalaman belajar yang
                  interaktif tentang bagaimana menanam dan merawat tanaman.
                  Temukan ragam flora khas dan nikmati suasana yang asri di
                  tengah kota.
                </p>
              </div>
            </div>
