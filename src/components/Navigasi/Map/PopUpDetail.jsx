  ...
  return (
    <>
      <div className="w-full h-screen fixed top-0 left-0 z-50 bg-black bg-opacity-50">
        <div className="w-11/12 md-2:w-2/5 h-fit py-10 px-20 bg-[#F8F9FA] rounded-xl shadow-xl fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <button
            onClick={onClick}
          ...
          <div className="flex flex-col items-center">
            <div className="w-full">
              <img
                src={popImage}
                className="w-full h-fit rounded-3xl mt-8 shadow-lg"
                alt=""
              />
            ...
            <p className="text-center text-lg md:text-xs">{detail}</p>
          </div>
        </div>
      </div>
    </>
